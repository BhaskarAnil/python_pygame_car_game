...
def opposite_vehicle(opposite_vehicle_x_position, opposite_vehicle_y_position):
    opposite_vehicle_image = pygame.image.load(
        'elements_images/oppvehicle2.png')
    screen.blit(opposite_vehicle_image,
                (opposite_vehicle_x_position, opposite_vehicle_y_position))
...
def check_for_collision(positions):
    ...
    distance_between_player_opposite_car = (
        ((player_position_x - opposite_car_position_x)**2)+((player_positon_y - opposite_car_position_y)**2))**(0.5)
...
def guide_to_play_messages():
    ...
    print_up_to_start = small_font.render(
        'Press (^) To Start', True, (255, 255, 255))
    screen.blit(print_up_to_start, (10, 300))
    print_move_left = small_font.render(
        'Use (<) To Move Left', True, (255, 255, 255))
    screen.blit(print_move_left, (10, 350))
    print_move_right = small_font.render(
        'Use (>) To Move Rightt', True, (255, 255, 255))
    screen.blit(print_move_right, (10, 400))
    print_move_up = small_font.render(
        'Use (^) To Move Forward', True, (255, 255, 255))
    screen.blit(print_move_up, (10, 450))
    print_move_down = small_font.render(
        'Use (v) To Move Backward', True, (255, 255, 255))
    screen.blit(print_move_down, (10, 500))
    print_move_jump = small_font.render(
        'Use Space Bar To Jump', True, (255, 255, 255))
...
while running:
    ...
    if collision:
        ...
        opposite_vehicle_position_dictionary = {'vehicle_1_1': [0, -1200], 'vehicle_1_2': [0, -100], 'vehicle_1_3': [0, -900], 'vehicle_2_1': [
            110, -500], 'vehicle_2_2': [110, -300], 'vehicle_2_3': [110, -500], 'vehicle_3_1': [210, -300], 'vehicle_3_2': [210, -200], 'vehicle_3_3': [210, -1000]}
    ...
    # If collision not occured this code block will be executed
        ...
        player_img = pygame.image.load(
            'elements_images/player.png')  # Load player image
        ...
        # player movements
        player_x_position, player_y_position = player_movements(
        ...
        for vehicle in opposite_vehicle_position_dictionary:
            ...
            if opposite_vehicle_position_dictionary[vehicle][1] > 1000:
                opposite_vehicle_position_dictionary[vehicle][1] = - \
                    random.choice([500, 1000, 1500, 2000, 2500, 3000])
            opposite_vehicle(
                opposite_vehicle_position_dictionary[vehicle][0], opposite_vehicle_position_dictionary[vehicle][1])
